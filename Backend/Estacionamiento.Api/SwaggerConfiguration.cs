namespace Estacionamiento.Api
{
    public class SwaggerConfiguration
    {
        ...
        public const string EndpointDescription = "Estacionamiento API v1";
        ...
        public const string DocInfoTitle = "Estacionamiento API";

        public const string DocInfoVersion = "v1";
        public const string DocInfoDescription = "Estacionamiento Api";
